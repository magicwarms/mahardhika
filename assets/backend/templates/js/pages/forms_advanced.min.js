					...
					var i = {
						...
						r = {
							init: function(i) {
								var a = i.attr("id"),
									s = a + "_count";
								r.isLimitless(), n = t("<span id=" + s + "/>");
								var o = t("<div/>").attr("id", a + "_counter").append(n).append(" " + r.setMsg());
								e.container_class && e.container_class.length && o.addClass(e.container_class), e.target && t(e.target).length ? e.append ? t(e.target).append(o) : t(e.target).prepend(o) : e.append ? o.insertAfter(i) : o.insertBefore(i), r.bind(i)
							},
							bind: function(t) {
								t.bind("keypress.counter keydown.counter keyup.counter blur.counter focus.counter change.counter paste.counter", r.updateCounter), t.bind("keydown.counter", r.doStopTyping), t.trigger("keydown")
							},
							isLimitless: function() {
								if ("sky" === e.goal) return e.count = "up", s = !0
							},
							setMsg: function() {
								if ("" !== e.msg) return e.msg;
								if (!1 === e.text) return "";
								if (s) return "" !== e.msg ? e.msg : "";
							...
							updateCounter: function(s) {
								var o = t(this);
								(a < 0 || a > e.goal) && r.passedGoal(o), e.type === i.type ? e.count === i.count ? (a = e.goal - o.val().length) <= 0 ? n.text("0") : n.text(a) : "up" === e.count && (a = o.val().length, n.text(a)) : "word" === e.type && (e.count === i.count ? (a = r.getWords(o.val())) <= e.goal ? (a = e.goal - a, n.text(a)) : n.text("0") : "up" === e.count && (a = r.getWords(o.val()), n.text(a)))
							},
							doStopTyping: function(t) {
								var n = [46, 8, 9, 35, 36, 37, 38, 39, 40, 32];
								if (r.isGoalReached(t) && t.keyCode !== n[0] && t.keyCode !== n[1] && t.keyCode !== n[2] && t.keyCode !== n[3] && t.keyCode !== n[4] && t.keyCode !== n[5] && t.keyCode !== n[6] && t.keyCode !== n[7] && t.keyCode !== n[8]) return e.type !== i.type && (t.keyCode !== n[9] && t.keyCode !== n[1] && e.type != i.type)
							},
							isGoalReached: function(t, n) {
								return !s && (e.count === i.count ? (n = 0, a <= n) : (n = e.goal, a >= n))
							},
							wordStrip: function(e, i) {
								var n = i.replace(/\s+/g, " ").split(" ").length;
								return i = t.trim(i), e <= 0 || e === n ? i : ((i = t.trim(i).split(" ")).splice(e, n, ""), t.trim(i.join(" ")))
							},
							passedGoal: function(t) {
								var i = t.val();
								"word" === e.type && t.val(r.wordStrip(e.goal, i)), "char" === e.type && t.val(i.substring(0, e.goal)), "down" === e.type && n.val("0"), "up" === e.type && n.val(e.goal)
							}
						};
	...
	adv_selects: function() {
		$("#selec_adv_1").selectize({
			...
			options: [{
				...
				id: 10,
				title: "WOH G64",
				url: "https://en.wikipedia.org/wiki/WOH_G64"
			}, {
				class: "star",
				id: 11,
				title: "RW Cephei",
				...
				class: "star",
				id: 12,
				title: "Westerlund 1-26",
				url: "https://en.wikipedia.org/wiki/Westerlund_1-26"
			}],
			optgroups: [{
				value: "planet",
				label: "Planets"
		...
		$("#selec_adv_2").selectize({
			...
			createFilter: function(e) {
				var i, n;
				return n = new RegExp("^" + t + "$", "i"), (i = e.match(n)) ? !this.options.hasOwnProperty(i[0]) : (n = new RegExp("^([^<]*)<" + t + ">$", "i"), !!(i = e.match(n)) && !this.options.hasOwnProperty(i[2]))
			},
			create: function(e) {
